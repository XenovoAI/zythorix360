-- Zythorix360 Database Migration Script (Fixed)
...
DROP TABLE IF EXISTS influencer_orders CASCADE;
...
('Physics Chapter 1 - Motion', 'Complete notes on motion and kinematics', 'Physics', 'Class 11', true, 0, 150),
('Chemistry Organic Reactions', 'Comprehensive guide to organic chemistry reactions', 'Chemistry', 'Class 12', false, 99, 89),
('Biology Human Physiology', 'Detailed notes on human body systems', 'Biology', 'Class 12', false, 149, 234),
('Mathematics Calculus', 'Complete calculus notes with solved examples', 'Mathematics', 'Class 12', true, 0, 456);
